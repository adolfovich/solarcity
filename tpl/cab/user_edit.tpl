          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
					...
					<?php } else { ?>
						<h3 class="mb-0">Редактирование: <?=$user_data['surname']?> <?=$user_data['name']?> </h3>
					<?php } ?>
                </div>
            ...
            <form id="userEdit" method="POST">
              ...
              <div class="row">
				...
				<div class="col-md-6">
                  <div class="form-group">
                    <input type="text" class="form-control" name="userFirstname" id="userFirstname" placeholder="Имя" value="<?=$user_data['name']?>">
                  </div>
                </div>
