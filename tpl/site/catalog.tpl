...
<html lang="ru-ru"><head>
    ...
    <script type="text/javascript" src="/assets/js/script.min.js"></script><script type="text/javascript" src="/js/auth.js"></script>		<script type="text/javascript">tobiz.blocks = [];</script>
        ...
        <div class="section_inner all_border width1170 middle center">
            <div class="arr1">
                <div data-hcolor="#475a64" style="width: 100%; color:#f9c000;  border-radius: 0em;   box-shadow: 0;  font-size: 18px;    ">
                    <input type="text" class="btn1" style="width: 100%; max-width: 100%; color: black; text-align: left; border-color: #f9c000;" />
                </div>
