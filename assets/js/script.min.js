...
</div>`),null!=window.tobiz.form_policy_text?window.tobiz.form_policy_text:'Нажимая на кнопку, Вы принимаете <a href="/?personal_data=1" target="_blank">Положение</a> и <a href="?personal_data=2" target="_blank">Согласие на обработку персональных данных</a>');"1"==_.result(t,"default_agreement","")&&$("#basket_right").append(`<div id="basket_form_default_agreement">${i}</div>`)}else{i=void 0!==t&&void 0!==t.basket_btn_text?t.basket_btn_text:"Оформить заказ";$("#basket_left .tools").append('<div id="basket_form_itogo">Итого: <span>'+this.countSum()+o.getCurrency()+"</span></div>"),$("#basket_right").append(`<div id="basket_title">${i}</div>`),$("#basket_right").append(`<div id="basket_make_order"><form action="handler.php" enctype="multipart/form-data" method="post">
<input type="hidden" name="action" value="basket"/>
<input type="hidden" name="amount" value="${o.countSum()}"/>
